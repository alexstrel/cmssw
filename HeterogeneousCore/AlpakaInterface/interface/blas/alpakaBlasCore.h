...
namespace cms::alpakatools{
  namespace blas{
    ...
    template <typename reduce_t_, typename Transformer, typename Reducer = reduce::plus<reduce_t_>, bool site_unroll_ = false>
     ...
     */    
     ...
     auto instantiateTransformReduceKernel(const TDevAcc &devAcc,
      ...
      auto& reduce_bufs = reduce::ReducerResource<reduce_t, TAcc, TDevAcc, TQueue>::get_reduction_resources(devAcc, queue, nSrc, max_reduce_blocks);
